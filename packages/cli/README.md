...
The wizard generates each bot wallet directly into Cassie's encrypted local keystore and
supports an optional organization-owned Splits Teams subaccount. See the bundled Cassie
operator skill for custody boundaries and recovery guidance.
